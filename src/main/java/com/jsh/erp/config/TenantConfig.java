        ...
        paginationInterceptor.setSqlParserFilter(new ISqlParserFilter() {
            ...
            public boolean doFilter(MetaObject metaObject) {
                ...
                if ("com.jsh.erp.datasource.mappers.UserMapperEx.getUserByWeixinOpenId".equals(ms.getId())) {
                    ...
                    return true;
                } else if ("com.jsh.erp.datasource.mappers.DepotItemMapperEx.batchUpsertAiPrediction".equals(ms.getId())) {
                    return true;
                } else if ("com.jsh.erp.datasource.mappers.DepotItemMapperEx.findStockWarningCount".equals(ms.getId())) {
                    return true;
                } else if ("com.jsh.erp.datasource.mappers.DepotItemMapperEx.findStockWarningCountTotal".equals(ms.getId())) {
                    return true;
                }
                return false;
            }
